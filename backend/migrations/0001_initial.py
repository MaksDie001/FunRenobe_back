# Generated by Django 4.1.7 on 2023-10-18 09:15
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender_choices', models.CharField(choices=[('мужчина', 'мужчина'), ('женщина', 'женщина'), ('существо', 'существо')], max_length=69, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('country', models.ForeignKey(default='неwйзвестно', on_delete=django.db.models.deletion.SET_DEFAULT, to='backend.counrty')),
        ...
        migrations.AddField(
            model_name='user',
            name='bookmarks',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='bookmarks', to='backend.renobe'),
        ),
        migrations.AddField(
            model_name='user',
            name='groups',
